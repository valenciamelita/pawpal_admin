                            ...
                            <ul class="sub-menu">
                                ...
                                <li>
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li><a href="single-product-variable">Product Variable</a></li>
                            ...
                            <div class="row">
                                <div class="col-xl-5 col-lg-5 col-md-5 col-sm-5 align-self-center sm-center-view">
                                    <div class="hero-slide-content slider-animated-1">
                                        ...
                                        <a href="shop-left-sidebar" class="btn btn-lg btn-primary btn-hover-dark"> Shop Now <i
                                                class="fa fa-shopping-basket ml-15px"
                                                ></i></a>
                                    </div>
                                </div>
                                <div
                                    ...
                                    <div class="show-case">
                                        <div class="hero-slide-image">
                                            <img src="{{asset('images/slider-image/slider-1.png')}}" alt="" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="container align-self-center">
                            <div class="row">
                                ...
                                <div
                                    ...
                                    <div class="show-case">
                                        <div class="hero-slide-image">
                                            <img src="{{asset('images/slider-image/slider-2.png')}}" alt="" />
                                        </div>
                                        <div class="display-wrapper">
                                            <div class="content-side">
                                                <h4 class="title">Full Dress</h4>
                                                <span class="price">$21.00</span>
                                                <a href="shop-left-sidebar" class="shop-link">Shop Now</a>
                                            </div>
                                            <div class="image-side">
                                                <img src="{{asset('images/slider-image/display-image.png')}}" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="single-col">
                        <a href="shop-left-sidebar" class="single-banner">
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px" data-aos="fade-up"
                                        ...
                                        <div class="product">
                                            ...
                                            <div class="content">
                                                ...
                                                <h5 class="title"><a href="single-product">Women's Elizabeth Coat
                                                    </a>
                                                </h5>
                                                <span class="price">
                                    ...
                                    <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px" data-aos="fade-up"
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="single-product" class="image">
                                                    <img src="{{asset('images/product-image/5.jpg')}}" alt="Product" />
                                            ...
                                            <div class="content">
                                                ...
                                                <h5 class="title"><a href="single-product">Women's Long Sleeve
                                                        Shirts</a></h5>
                                                <span class="price">
                                    ...
                                    <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px" data-aos="fade-up"
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="single-product" class="image">
                                                    <img src="{{asset('images/product-image/7.jpg')}}" alt="Product" />
                                                    <img class="hover-image" src="{{asset('images/product-image/8.jpg')}}"
                                                        alt="Product" />
                                                </a>
                                                <span class="badges">
                                            ...
                                            <div class="content">
                                                ...
                                                <h5 class="title"><a href="single-product">Parrera Sunglasses -
                                                        Lomashop</a></h5>
                                                <span class="price">
                                                    <span class="new">$38.50</span>
                                                </span>
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="single-product" class="image">
                                                    ...
                                                    <img class="hover-image" src="{{asset('images/product-image/10.jpg')}}"
                                                        alt="Product" />
                                                </a>
                                                <span class="badges">
                                            ...
                                            <div class="content">
                                                ...
                                                <h5 class="title"><a href="single-product">Cool Man Wearing
                                                        Leather</a></h5>
                                                <span class="price">
                                                    <span class="new">$38.50</span>
                                    ...
                                    <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6  mb-md-30px mb-lm-30px"
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="single-product" class="image">
                                                    <img src="{{asset('images/product-image/4.jpg')}}" alt="Product')}}" />
                                                    <img class="hover-image" src="{{asset('images/product-image/12.jpg')}}"
                                                        alt="Product" />
                                                </a>
                                                <span class="badges">
                                                </span>
                                            ...
                                            <div class="content">
                                                ...
                                                <h5 class="title"><a href="single-product">Portrait Of A Young
                                                        Stylish</a>
                                                </h5>
                                                <span class="price">
                                                    <span class="new">$38.50</span>
                                    ...
                                    <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-es-30px" data-aos="fade-up"
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="single-product" class="image">
                                                    <img src="{{asset('images/product-image/6.jpg')}}" alt="Product" />
                                                    <img class="hover-image" src="{{asset('images/product-image/14.jpg')}}"
                                                        alt="Product" />
                                                </a>
                                                <span class="badges">
                                                </span>
                                            ...
                                            <div class="content">
                                                ...
                                                <h5 class="title"><a href="single-product">Men's Fashion Leather
                                                        Bag</a></h5>
                                                <span class="price">
                                                    <span class="new">$30.50</span>
                                                </span>
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="single-product" class="image">
                                                    ...
                                                    <img class="hover-image" src="{{asset('images/product-image/16.jpg')}}"
                                                        alt="Product" />
                                                </a>
                                                <span class="badges">
                                                    <span class="new">Sale</span>
                                            ...
                                            <div class="content">
                                                ...
                                                <h5 class="title"><a href="single-product">Long sleeve knee
                                                        length</a></h5>
                                                <span class="price">
                                                    <span class="new">$38.50</span>
                                                </span>
                    ...
                    <div class="col-12">
                        <div class="deal-inner deal-bg position-relative pt-100px pb-100px"
                            ...
                            <div class="deal-wrapper">
                                ...
                                <a href="single-product-variable" class="btn btn-lg btn-primary btn-hover-dark m-auto"> Shop
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <img class="img-responsive m-auto"
                                                src="{{asset('images/product-image/zoom-image/1.jpg')}}" alt="">
                                        </div>
                                        <div class="swiper-slide">
                                            <img class="img-responsive m-auto"
