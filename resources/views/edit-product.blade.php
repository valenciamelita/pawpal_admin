                                ...
                                <div class="product-details-content quickview-content">
                                    <form action="{{ route('product.update', $product->PRODUCT_ID) }}" method="post">
                                        ...
                                        <div class="category">
                                            <div class="prodCat">
                                                ...
                                                <select name="productCat" id="productCat">
                                                    @foreach($categoryNames as $categoryName)
                                                        <option value="{{ $categoryName->category_name }}" {{ $product->CATEGORY_NAME == $categoryName->category_name ? 'selected' : '' }}>
                                            ...
                                            <div class="animal">
                                                <h3>Animal</h3>
                                                <select name="productAnimal" id="productAnimal">
                                                    @foreach($animals as $animal)
                                                    <option value="{{ $animal->CATEGORY_ANIMAL }}" {{ $product->CATEGORY_ANIMAL == $animal->CATEGORY_ANIMAL ? 'selected' : '' }}>
                                        ...
                                        <div class="edit-desc">
                                            <h3>Description</h3>
                                            <textarea id="editDesc" name="editDesc" rows="4" cols="50">{{ $product->PRODUCT_DESC }}</textarea>
                                        </div>
                                        <button class="button-img"> Edit Image ✎ </button>

                                        <div class="pricing-meta">
                                            <h3>Price</h3>
                                            <input type="text" id="productPrice" name="productPrice" value="{{ $product->PRODUCT_PRICE }}">
                                        </div>
                                        <h4 class="editStock">Edit Stock</h4>
                                        <div class="pro-details-quality">
                                            <div class="cart-plus-minus">
                                                <input class="cart-plus-minus-box" type="text" name="qtybutton" value="{{ $product->PRODUCT_STOCK }}" />
                                            </div>
                                            <br>
                                            <br>
                                            <div class="pro-details-cart">
                                                <button type="submit" class="add-cart"> Save Changes</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
